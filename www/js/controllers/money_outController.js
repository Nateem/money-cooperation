angular.module('money')
  .controller('money_outController',function ($rootScope,$scope,$cordovaDatePicker,$cordovaDialogs,$cordovaSQLite,$cordovaToast,$state) {
    ...
    $scope.$on("$ionicView.afterEnter", function(event, data) {
      ...
      $scope.submitFormOut = function (myForm, TYPE_ID, VALUE, NOTE, CUR_DATE, CUR_TIME) {
        var DNOW = new Date();
        var TYPE_ID = TYPE_ID;
        var VALUE = VALUE;
        var NOTE = NOTE;
